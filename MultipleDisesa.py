...
background_image_url = "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.istockphoto.com%2Fphotos%2Fheart-disease&psig=AOvVaw1culYc-bY6DbMUSYxdH6LK&ust=1730474484412000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCNiN0_r1uIkDFQAAAAAdAAAAABAS"  # Replace with your image URL

st.markdown(
    f"""
    <style>
    .stApp {{
        background-image: url("https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.istockphoto.com%2Fphotos%2Fheart-disease&psig=AOvVaw1culYc-bY6DbMUSYxdH6LK&ust=1730474484412000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCNiN0_r1uIkDFQAAAAAdAAAAABAS");
...
if (selected== 'Parkinson Prediction'):
    ...
    st.title('Parkinson Prediction Model ')
    ...
    if st.button("Parkinson's Test Result"):
        ...
        parkinsons_prediction = parkinson__model.predict([user_input])
